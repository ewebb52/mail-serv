...
### Reset Enviro
if [ -d "malicious-root" ]; then rm -Rf "malicious-root"; fi

# Prepare the directory
mkdir malicious-root
cd malicious-root
mkdir ca
...
cp "${BASE}/init/malicious-openssl.cnf" "${ROOT}/openssl.cnf"
...
cp "${BASE}/init/malicious-intra-openssl.cnf" "${INTERMEDIATE}/openssl.cnf"
cd ${INTERMEDIATE}
cd $ROOT
